...
const tradiciones = [
  ...
  },
  {
    ...
    titulo: "Feria del Limón",
    mes: "Abril · Mayo",
    meses: [3, 4],
    lugar: "Tecomán",
    descripcion: "Tecomán, capital mundial del limón persa, celebra su producto más famoso con exposiciones agroindustriales, concursos de cocina con limón, música regional y recorridos por los campos limoneros más extensos del país.",
  },
  {
    icon: <Ship size={20} />,
  ...
  {
    icon: <Ship size={20} />,
    titulo: "Torneo de Pez Vela — Segunda fecha",
    mes: "Noviembre",
    meses: [10],
    lugar: "Manzanillo",
    descripcion: "Segunda edición anual del torneo internacional de pesca deportiva. La temporada de noviembre atrae a los mejores equipos de pesca del Pacífico americano en aguas de Manzanillo.",
  },
  {
    icon: <Music size={20} />,
