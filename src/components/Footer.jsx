...
export default function Footer() {
 ...
 <a href="https://www.facebook.com/profile.php?id=61591669495040" target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="Facebook">
  <Facebook className="footer-social-icon" />
</a>
<a href="https://www.instagram.com/tulimacolima/" target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="Instagram">
